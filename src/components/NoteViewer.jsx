...
export default function NoteViewer( {note ,setSelectedNote,editingNoteId, handleEditClick, handleUpdateNote , handleDeleteNote } ) {
    ...
    return (
        ...
        <div className='absolute inset-0 bg-linear-to-br from-[#763ea0] via-[#571788] to-[#331b58] border border-[#754797]  text-amber-50 left-[20%] top-[30%] p-6 rounded-[10px] w-[510px] h-[211px] flex flex-col gap-2.5'>
                ...
                <div  className='flex justify-between mb-2.5'>
                    ...
                    <button onClick={() => setSelectedNote(false)} className=' absolute left-[482px] text-[17px] font-bold text-lg  top-0 hover:scale-[1.3] '>&times;</button>
                    <div  className='flex'>
